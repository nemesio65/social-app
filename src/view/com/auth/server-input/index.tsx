    ...
    <Dialog.ScrollableInner
      ...
      <View style={[a.relative, a.gap_md, a.w_full]}>
        ...
        <ToggleButton.Group
          ...
          <ToggleButton.Button name={BSKY_SERVICE} label={_(msg`TokedGamers`)}>
        ...
        {fixedOption === BSKY_SERVICE && isFirstTimeUser && (
          <Admonition type="tip">
            <Trans>
              TokedGamers is an open network where you can choose your own
              provider. If you're new here, we recommend sticking with the
              default TokedGamers Social option.
            </Trans>
          </Admonition>
        )}
        ...
        <View style={[a.py_xs]}>
          <P
            ...
            {isFirstTimeUser ? (
              ...
              <Trans>
                TokedGamers is an open network where you can choose your hosting
